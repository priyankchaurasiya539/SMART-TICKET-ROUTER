...
## Project Structure
smart-ticket-router/
├── ML_pipeline/     # Model training scripts & data telemetry
├── backend/         # FastAPI engine & production artifacts (.pkl)
├── frontend/        # Streamlit web interface portal
└── ticket_system.db # Storage ledger
